...
//$keywords = 'Yellow|Yesterday';

// Список ключевых слов/функций
...
$text = preg_replace("#<#s","&lt;", $text );
$text = preg_replace("#>#s","&gt;", $text );
$text = preg_replace("#\n#s","\002", $text );    // перевод строки
$text = preg_replace("#\s#s","&nbsp;", $text );  // пробелы
