...
")/sm";
  ...
  function WackoCallback($things)
  {
    ...
    // urls
      ...
      || substr($url,-5)==".jpeg") return "<img src=\"".$matches[1]."\" alt=\"\" />".$matches[2];
...
class WackoFormatterConfigDefault
{
 ...
 function WackoFormatterConfigDefault() {}

 //return unique identifier of this page - STUB
 function GetPageId() { return 0; }

 //return value of some configuration option 
 function GetConfigValue($option) { return $this->config[$option]; }

 //format piece of text with some formatter - STUB
