...
<table id="table_assigned_vars">
    {section name=vars loop=$_debug_keys}
        <tr class="{cycle values="odd,even"}">
            <th onclick="toggle('{$_debug_keys[vars]}');" style="cursor:default;cursor:pointer;">{ldelim}${$_debug_keys[vars]|escape:'html'}{rdelim}</th>
            <td id="{$_debug_keys[vars]}" class="hide">{$_debug_vals[vars]|@debug_print_var}</td></tr>
    {sectionelse}
